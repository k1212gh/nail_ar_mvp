...
| 입력 | conf | 검출률 | 노트북 CPU | 폰 CPU(투영) |
|---|---|---|---|---|
| 640² | 0.20 | 64% | 254ms (3.9fps) | ~479ms (2fps) |
| 416² | 0.20 | 48% | 104ms (9.6fps) | ~200ms (5fps) |
| 320² | 0.20 | 45% | 65ms (15fps) | ~120ms (8fps) |
| **320²** | **0.08** | **56%** | **62ms (16fps)** | **~120ms (~8fps)** ⭐ |
