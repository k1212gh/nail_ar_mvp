...
namespace Unity.XR.RayNeo.OpenXR.ARDK
{
    ...
    public class RayNeoSupportFeature : RayNeoOpenXRFeatureBase
    {
        ...
        public StartupCameraAttitudeType CameraAttitudeType = StartupCameraAttitudeType.DOF3;
        ...
        {            
            ...
            settings.Add("trackerAlgorithm", (int)CameraAttitudeType);
    ...
    public enum StartupCameraAttitudeType
    {
        //NONE,
        DOF3 = 0x1001,
        //DOF3_WITH_ABSOLUTE_ORIENTATION = 0x1002,
        SLAM = 0x2001,
    }
}