...
namespace RayNeo.API
{
  ...
  return (LibLoadResult)CurActivity.Call<int>("GetLibLoadResult");
        ...
        /// 设置是否互换镜腿交互事件
        /// </summary>
        /// <param name="isExchanged">false : 不互换; true : 互换</param>
        public static void SetGlassLegTouchEventExchange(bool isExchanged)
        {
            CurActivity.Call("SetGlassLegTouchEventExchange", isExchanged);
        }
