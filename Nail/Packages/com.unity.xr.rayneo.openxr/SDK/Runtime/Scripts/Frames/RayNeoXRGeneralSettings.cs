...
namespace RayNeo
{
    ...
    public class RayNeoXRGeneralSettings : ScriptableObject
    {
        ...
        [SerializeField]
        public List<LiteTouchConfig> touchConfigs;
        [SerializeField]
        ...
        #region runtime
        [NonSerialized]
        private Dictionary<RayNeo.API.DeviceType, LiteTouchConfig> m_touchConfigDict = new Dictionary<RayNeo.API.DeviceType, LiteTouchConfig>();

        public LiteTouchConfig SimpleTouchConfig
        {
            get
            {
        ...
        public LiteTouchConfig GetSimpleTouchConfig(RayNeo.API.DeviceType t)
        {
        ...
        public void CreateDefaultData()
        {
            ...
            {
                touchConfigs = new List<LiteTouchConfig>();
            }
            ...
            for (int i = 0; i < ev.Length; i++)
            {
                ...
                if (!digout)
                {
                    touchConfigs.Add(new LiteTouchConfig()
                    {
