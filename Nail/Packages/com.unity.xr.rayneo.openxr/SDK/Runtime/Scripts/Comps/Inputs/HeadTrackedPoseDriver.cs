...
namespace RayNeo
{
    ...
    internal class HeadTrackedPoseParams
    {
        ...
        /// <summary>
        /// 初始化 HeadTrackedPoseDriver 一些配置
        /// </summary>
        /// <param name="hdk">HeadTrackedPoseDriver</param>
        /// <param name="resetAction">重置事件</param>
        ...
        /// 获取实际的旋转
        /// </summary>
        /// <param name="rawQuat">原始的旋转</param>
        /// <returns>转换后的旋转</returns>
